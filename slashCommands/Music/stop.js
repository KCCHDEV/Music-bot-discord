...
module.exports = {
	...
	description: "หยุดร้องเพลงแล้วออกจากห้อง", //the command description for Slash Command Overview
	cooldown: 5,
				...
				if (!newQueue || !newQueue.songs || newQueue.songs.length == 0) {
					...
					interaction.reply({
						embeds: [new MessageEmbed()
						  .setColor(ee.color)
						  .setTimestamp()
						  .setTitle(`⏹ **หยุดร้องเพลงแล้วออกจากห้อง**`)
						  .setFooter(`💢 หยุดหนูโดย: ${member.user.tag}`, member.user.displayAvatarURL({dynamic: true}))]
					})
				}
