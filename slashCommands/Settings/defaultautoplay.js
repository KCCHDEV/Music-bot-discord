...
module.exports = {
  ...
  description: "การเริ่มต้นของ Autoplay", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      ...
      return interaction.reply({
        embeds: [
          ...
          .setTitle(`${client.allEmojis.check_mark} **Default-Autoplay คือ __\`${client.settings.get(guild.id, "defaultautoplay") ? "เปิด" : "ปิด"}\`__!**`)
        ],
      })
    } catch (e) {
