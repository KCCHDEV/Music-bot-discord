...
module.exports = {
  ...
  description: "ตั้งค่า Default Volume", //the command description for helpcmd [OPTIONAL]
  ...
  options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
    ...
    //{"Integer": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getInteger("ping_amount")
    {
      "Integer": {
        name: "volume",
        description: "Volume ตั้งได้ตั้งแต่ 1 ถึง 150!",
        required: true
      }
    ...
    try {
      ...
      if (!volume || (volume > 150 || volume < 1)) {
        return interaction.reply({
          ...
          embeds: [
            ...
            .setTitle(`${client.allEmojis.x} **"Volume ตั้งได้ตั้งแต่ \`1\` ถึง \`150\`!**`)
          ],
        })
      }
      ...
      return interaction.reply({
        ...
        embeds: [
          ...
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setTitle(`${client.allEmojis.check_mark} ** Default-Volume ตั้งค่าเป็น: \`${volume}\`!**`)
        ],
      })
    } catch (e) {
