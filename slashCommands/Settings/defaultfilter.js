...
module.exports = {
  ...
  description: "Filter เริ่มต้น", //the command description for helpcmd [OPTIONAL]
  ...
  options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
    ...
    //{"Integer": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getInteger("ping_amount")
    {
      "String": {
        name: "filters",
        description: "Filter ที่คุณต้องการให้เป็นตัวเริ่มต้น",
        required: true
      }
      ...
      if (args.some(a => !filters[a])) {
        return interaction.reply({
          embeds: [
            ...
            .setDescription("**To กำหนดตัวกรองหลายตัว เพิ่มช่องว่าง (` `) ในระหว่าง!**")
            .addField("**All Filters:**", Object.keys(filters).map(f => `\`${f}\``).join(", "))
          ],
        })
      }
