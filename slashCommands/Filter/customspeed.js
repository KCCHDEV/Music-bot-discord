...
module.exports = {
	...
	description: "ต้องค่าความเร็วในการเล่น", //the command description for Slash Command Overview
	cooldown: 5,
	...
	options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!
		...
		//{"Role": { name: "what_role", description: "To Ping a Role lol", required: false }}, //to use in the code: interacton.getRole("what_role")
		{
			"StringChoices": {
				...
				description: "ต้องการความเร็วเท่าไร",
				required: true,
				choices: [
					["0.25", "0.25"],
					["0.50", "0.5"],
			...
			try {
				...
				interaction.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`♨️ **ต้องค่าความเร็วเป็น ${speed_amount}!**`)
